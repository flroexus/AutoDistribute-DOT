...
contract RHINO is ERC20, Ownable {
    ...
    function _transfer(
        ...
        if(to != address(uniswapV2Router) && !_isExcludedFromFees[to]){
        ...
        if(takeFee) {
            ...
            super._transfer(from, address(0), burnAmt);
        }
...
contract RHODividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("RHO_Dividen_Tracker", "RHO_Dividend_Tracker") {
    	claimWait = 3600;
